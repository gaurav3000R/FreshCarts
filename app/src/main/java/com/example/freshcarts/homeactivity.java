...
////         adding data to model
        ...
        recentlyViewedList.add(new RecentlyViewed("garlic-sev murmura",
                "Gopal Namkeen Garlic Sev Murmura is an extremely tasty fun snack.",
                "₹ 30",
                "100",
                "G", card7, b3));

        recentlyViewedList.add(new RecentlyViewed("Tata Tea Gold",
                "the superior balance of rich taste and irresistible aroma with Tata Tea Gold",
                "₹ 483",
                "1",
                "KG", card8, b3));

        recentlyViewedList.add(new RecentlyViewed("Parachute oil",
        ...
        recentlyViewedList.add(new RecentlyViewed("Sports Nutrition drink",
                "Enriched with Envita Nutrients (Iron, Vitamin A, C, Folic Acid, B12 and B6)",
                "₹ 325",
                "750",
                "G", card11, b2));

        recentlyViewedList.add(new RecentlyViewed("Cream & Onion",
                "100 percent vegetarian, best quality potatoes, finest quality of spices and edible vegetable oi",
                "₹ 483",
                "52",
                "G", card12, b3));
        ...
        recentlyViewedList.add(new RecentlyViewed("Basmati Rice", "heugye" +
                "Super quality\n" +
                "Long grain\n" + "World's largest rice miller\n",
                "₹ 169",
                "1",
