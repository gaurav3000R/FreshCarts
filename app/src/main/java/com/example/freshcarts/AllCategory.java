...
import com.example.freshcarts.adpter.AllCategoryAdapter;
import com.example.freshcarts.model.AllCategoryModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back = new Intent(AllCategory.this, Mainactivity3.class);
                startActivity(back);
                finish();
            }
        });
        ...
        allCategoryModelList.add(new AllCategoryModel(10,R.drawable.ic_cookies));
